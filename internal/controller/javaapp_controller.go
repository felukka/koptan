...
// JavaAppReconciler reconciles a JavaApp object
type JavaAppReconciler struct {
	client.Client
...
// the JavaApp object against the actual cluster state, and then
...
func (r *JavaAppReconciler) SetupWithManager(mgr ctrl.Manager) error {
